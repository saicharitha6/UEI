...
<h2 class="text-center mt-20 font-bold text-2xl text-green-600">Daily News</h2>

<div
  class="news grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 justify-center md:justify-center"
>
  {#each news as card}
    <Card class="overflow-hidden hover:translate-y-1 floating">
      ...
      <div class="items-center p-5">
        <Button
          class="w-fit bg-green-500 hover:bg-green-600 font-bold justify-center"
        >
        ...
        <div class="mt-5 left-5 flex flex-row flex-auto">
          <svg
            class="w-7 h-7 text-gray-800 dark:text-white mr-5"
            aria-hidden="true"
          ...
          <svg
            class="w-7 h-7 text-gray-800 dark:text-white mx-5"
            aria-hidden="true"
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"

...
<h3
  class="text-[29px] text-black text-center font-bold mt-20 mb-5 font-inter"
...
<div
  class="justify-center flex  mb-[3vw] mt-[5vw] text-white hover:text-gray-200" style="font-family: 'Open Sans'"
>
  <a href={"/form"} class="text-[20px] bg-black font-bold py-3 px-5 rounded-lg flex items-center">
